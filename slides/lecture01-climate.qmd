...
1. Index insurance: if some index $I$ is above a threshold $I^*$, pay out $X$
    1. Total rainfall in a season, area flooded, etc
1. Naive pricing: $R = p(I > I^*)X$
    1. $p(I > I^*)$ is the probability of a payout
    1. Requires knowing $p(I)$
1. Riskier investments require higher returns
    1. Risk premium -- depends on $p(I > I^*)$, the uncertainty in $p(I > I^*)$, the risk aversion of the insurer, etc
