...
#show heading.where(level: 1): it => block(above: 1.4em, below: 0.5em)[
  #text(fill: rice-blue, weight: "bold", size: 1.15em, it.body)
]
#show heading.where(level: 2): it => block(above: 1.0em, below: 0.4em)[
  #text(fill: rice-midnight, weight: "semibold", size: 1.0em, it.body)
]
#show heading.where(level: 3): it => block(above: 0.8em, below: 0.3em)[
  #text(fill: rice-midnight, weight: "medium", size: 0.95em, it.body)
]
