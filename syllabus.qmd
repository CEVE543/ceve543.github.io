...
AI tools, specifically Large Language Models (LLMs) can be incredibly powerful aids in learning, and can help beginner programmers with syntax and code structure.
...
We will discuss the use of these tools in class, and I will provide guidance on how to use them responsibly.
You are encouraged to use these tools for coding, but you *must be responsible for understanding the work you submit*.

This policy applies to your instructors.
For example, while we might use LLMs to draft a detailed scoring rubric for an assignment, your assignments will not be graded by LLMs.
Similarly, while we might use LLMs to add comments to example code that we provide, we will not ask it to write code that we do not understand or stand behind.

The rapidly evolving nature of AI tools is posing and emphasizing fundamental questions about the nature of learning and education, such as what skills students need to develop, how to assess those skills, and how to prepare students for a world in which AI tools are ubiquitous.
The course [list of LLM resources](/resources/llm.qmd) provides a few links and resources that scratch the surface of these questions, and you are encouraged to explore these and other resources.

For the purposes of this course, we take the position that the goal of learning is articulated in the course learning objectives.
Rather than trying to prevent and punish "cheating", we take the position that students will use LLMs on take-home and written material, and should therefore learn how to do so responsibly, and that assessment needs to focus on approaches, including tests and in-class activities, that are not readily amenable to LLM use (note that the use of any hypothetical wearable AI device is prohibited).
