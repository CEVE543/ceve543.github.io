...
Due [Wednesday, November 19th](/schedule.qmd).
...
![@lorenz_deterministic:1963 attractor](lorenz-1963.png)
:::
::: {.column width="50%"}
...
:::
::: {.column width="20%"}
![Conceptual sketch of nonlinear dynamics [@palmer_dynamical:1999]](palmer-jclim-1999.png)
:::
:::
...
::: {.fragment}
Key milestones (per [CarbonBrief](https://www.carbonbrief.org/timeline-history-climate-modelling/)):
...
## Using Climate Model Simulations {.smaller}

::: {.fragment}
Climate models are computationally expensive.
We rarely run them ourselves—instead, we use existing simulations.
:::
...
::: {.fragment}
[Sixth phase](https://wcrp-cmip.org/cmip-phases/cmip6/) (2015-present) addresses three questions:
